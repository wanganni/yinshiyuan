...
class Spider(Spider):
    ...
    def searchContent(self, key, quick, page='1'):
        ...
        try:
            ...
            url = f"https://996624.yachts/cn/home/web/index.php/vod/search/wd/{urllib.parse.quote(key)}/page/{page}.html"
            rsp = self.fetch(url)
            if rsp and rsp.text:
                doc = pq(rsp.text)
                items = doc('.stui-vodlist li')
        ...
        try:
            ...
            if id.startswith('http'):
                ...
                if id.startswith('/'):
                    ...
                    play_url = "https://996624.yachts/cn/home/web/" + id
